...
05.11.24:
          ...
          - *Доработка recipiesapp функционала* 
            ...
            - Нужно добавить поиск при выборе списка продуктов
            - Нужно добавить возможность добавления своего продукта
            - Нужно поставить условия, что для сыпучих продуктов не надо заполнять кбжу(проверить есть ли для них кбжу), или если выбрано по вкусу, то тоже не надо кбжу и кол-во
            - Отработать работу фильтра по калорийности, т.е. при создании рецепта сделать его установку в автоматическом режиме. 
            - Надо, чтобы показывались ошибки, в каких полях и почему.


            - Надо, чтобы при неправильной отправке форм, поля не удаляли данные.
...
06.11.24
          - *Стилизация*
              ...
              - сss всех страниц
              - Сделать адаптив под все расширения
              - сделать чтобы фотографии имели одинаковый размер  
              - сделать вывод вспомогательных полей и ссообщений
